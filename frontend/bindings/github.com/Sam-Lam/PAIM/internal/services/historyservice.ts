 ...
 */
export function DismissFailure(failureID: string, reason: string): $CancellablePromise<$models.ImportFailureDTO> {
    return $Call.ByID(2153037436, failureID, reason);
}
 ...
 */
export function ListSessionFailures(sessionID: string, page: number, pageSize: number): $CancellablePromise<$models.PageResult<$models.ImportFailureDTO>> {
    return $Call.ByID(1441266633, sessionID, page, pageSize);
}
