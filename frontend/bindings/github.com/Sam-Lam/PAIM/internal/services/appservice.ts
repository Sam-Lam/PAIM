 ...
 */
export function ActiveOperations(): $CancellablePromise<$models.OperationInfo[] | null> {
    return $Call.ByID(3808902125);
}
 ...
 */
export function Version(): $CancellablePromise<$models.VersionInfo> {
    return $Call.ByID(4223251063);
}
