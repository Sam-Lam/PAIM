 ...
 */
export function PlanReorganize(eventName: string, useSourceFolderLabels: boolean): $CancellablePromise<$models.ReorganizePlanDTO | null> {
    return $Call.ByID(2236467974, eventName, useSourceFolderLabels);
}
 ...
 */
export function RetryFailedFile(failureID: string): $CancellablePromise<$models.RetryFailedFileResult> {
    return $Call.ByID(1556548466, failureID);
}
