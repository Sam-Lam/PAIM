...
export class RWMutex {
    /**
     * Creates a new RWMutex instance.
     * @param {Partial<RWMutex>} [$$source = {}] - The source object to create the RWMutex.
     */
    constructor($$source = {}) {
    ...
    /**
     * Creates a new RWMutex instance from a string or object.
     * @param {any} [$$source = {}]
     * @returns {RWMutex}
     */
    static createFrom($$source = {}) {
        let $$parsedSource = typeof $$source === 'string' ? JSON.parse($$source) : $$source;
        return new RWMutex(/** @type {Partial<RWMutex>} */($$parsedSource));
    }
}
